...
create_directories() {
  ...
  then
    ...
    echo -e "${LTGREEN}COMMAND: ${GRAY}chmod -R 2777 ${SCRIPTS_DEST_DIR}/${COURSE_NUM}${NC}"
    chmod -R 2777 ${SCRIPTS_DEST_DIR}/${COURSE_NUM}
    echo
  fi
  ...
  then
    ...
    echo -e "${LTGREEN}COMMAND: ${GRAY}chmod -R g+s ${PDF_DEST_DIR}/${COURSE_NUM}${NC}"
    chmod -R g+s ${PDF_DEST_DIR}/${COURSE_NUM}
    echo
  fi
}
...
copy_course_files() {
  ...
  then
    ...
    then
      ...
      echo -e "${LTGREEN}COMMAND: ${GRAY}cp -R course_files/* ${HOME}/course_files/${COURSE_NUM}/${NC}"
